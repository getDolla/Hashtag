...
public class HashTableQP {
    ...
    private final int _NUMVALS = 7;  //number of elements to store
    ...
    private String[] times = new String[_CAPACITY];
	...
	for( String s : vals ) {
        ...
        times[_size] = (System.nanoTime() - initime) + " " + _collisions;
    ...
    private void printTimes() {
        System.out.println( "Nanoseconds: Collisions:");
